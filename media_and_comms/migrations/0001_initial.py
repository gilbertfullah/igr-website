# Generated by Django 4.1.1 on 2023-11-28 13:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='podcast',
            index=models.Index(fields=['id'], name='podcast_id_idx', opclasses=['uuid_ops']),
        ),
        migrations.AddField(
            model_name='news',
            name='tags',
        ...
        migrations.AddIndex(
            model_name='gallery',
            index=models.Index(fields=['id'], name='gallery_id_idx', opclasses=['uuid_ops']),
        ),
        migrations.AddField(
            model_name='comment',
            name='parent_post',
        ...
        migrations.AddIndex(
            model_name='reply',
            index=models.Index(fields=['id'], name='reply_id_idx', opclasses=['uuid_ops']),
        ),
        migrations.AddIndex(
            model_name='release',
            index=models.Index(fields=['id'], name='release_id_idx', opclasses=['uuid_ops']),
        ),
        migrations.AddIndex(
            model_name='news',
            index=models.Index(fields=['id'], name='news_id_idx', opclasses=['uuid_ops']),
        ),
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['id'], name='comment_id_idx', opclasses=['uuid_ops']),
        ),
    ]
